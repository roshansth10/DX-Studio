...
import { navigateTo, usePathname } from "../routing";
...
export const Navigation: React.FC<NavigationProps> = ({
  ...
  const themeOptions: {
    ...
    {
      id: "warm-light",
      label: "Warm Scandinavian (Default)",
      bg: "#F7F7F5",
      border: "#E5E5E2",
    },
    {
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 lg:px-12">
          ...
          <div className="flex items-center gap-2 lg:hidden">
            ...
            <button
              ...
              aria-label={
                isMuted
                  ? "Unmute studio ambient loop"
                  : "Mute studio ambient loop"
              }
              title={
                isMuted ? "Listen to studio ambient loop" : "Mute studio sound"
              }
            >
              {!isMuted ? (
