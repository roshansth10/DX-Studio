...
stats: { label: "Catalog Items", value: "1000+" },
  ...
  },
  {
    ...
    title: "Apex Abroad",
    client: "Apex Abroad",
    category: "Education Consultancy / Web Development",
    portfolioCategory: "Creative Websites",
    year: "2026",
    tagline: "Your Future. Our Guidance.",
    description:
      "A full-service international education consultancy website that guides students from test preparation to visa approval, covering IELTS, PTE and SAT prep, counseling, application assistance, and scholarship support.",
    metrics: [
      "End-to-End Journey Guidance",
      "8 Global Destinations Covered",
      "Clear Service Architecture",
    ],
    deliverables: [
      "Consultancy Website",
    ...
    image: "/image/apex.png",
    aspect: "wide",
    colorAccent: "#0E7490",
    stats: { label: "Students Guided", value: "5000+" },
    link: "https://apexabroad.vercel.app",
  },
  {
    id: "photography-portfolio",
    number: "06",
    title: "Photography Portfolio",
    client: "Prabin Shrestha",
    category: "Photography / Visual Portfolio",
    portfolioCategory: "Other",
    year: "2026",
    tagline: "Visual Stories from Nepal.",
    description:
      "A photography portfolio presenting visual stories captured across Nepal, built on a minimal, image-led layout that keeps the work front and centre on every screen.",
    metrics: [
      "Image-Led Presentation",
      "Full-Bleed Gallery Layout",
    ...
    aspect: "wide",
    colorAccent: "#B45309",
    stats: { label: "Speciality", value: "Travel & Documentary" },
    link: "https://photoportfoli0.vercel.app",
  },
];
